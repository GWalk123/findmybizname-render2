      ...
      <div class="container">
        <div class="content">
          <div class="guarantee-box">
            <h2 style="margin-top: 0;">🛡️ 30-Day Money-Back Guarantee</h2>
...
app.get('/', (req, res) => {
  res.send(`
    ...
    <body>
      ...
      <!-- ABOUT with Blue primary theme -->
      <section class="section" id="about">
        <div class="container">
          <h2>Breaking the Business Tool Cartel</h2>
          <p>Traditional business tools cost $30,456/year and exclude 430.5M underbanked entrepreneurs. We provide MORE features at 94% LESS cost with global payment access.</p>
          
          <div class="features">
            <div class="feature-card">
              <h3>🌍 Global Accessibility</h3>
              <p>Serving underbanked markets in 195+ countries with cryptocurrency payment options that traditional processors refuse to support.</p>
            </div>
            
            <div class="feature-card">
              <h3>💡 Complete Integration</h3>
              <p>15+ business tools in one platform vs. paying separately for naming, domains, CRM, invoicing, payments, and analytics.</p>
            </div>
            
            <div class="feature-card">
              <h3>⚡ Built for Speed</h3>
              <p>Launch your complete business in minutes, not weeks. AI-powered automation handles the technical complexity.</p>
            </div>
          </div>
        </div>
      </section>

      <!-- FOOTER with Blue primary background -->
      <footer class="footer" id="contact">
        <div class="container">
          <div class="footer-links">
            ...
            <a href="mailto:support@findmybizname.com">Support</a>
          </div>
